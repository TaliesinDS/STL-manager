"""
Compatibility shim: delegates to canonical implementation in scripts/60_reports_analysis/annotate_proposals_with_hints.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "60_reports_analysis" / "annotate_proposals_with_hints.py"
MODULE_NAME = "scripts.60_reports_analysis.annotate_proposals_with_hints"
