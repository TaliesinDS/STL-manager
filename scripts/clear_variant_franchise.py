"""Compatibility shim: delegates to canonical implementation in scripts/50_cleanup_repair/clear_variant_franchise.py"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "50_cleanup_repair" / "clear_variant_franchise.py"
MODULE_NAME = "scripts.50_cleanup_repair.clear_variant_franchise"
