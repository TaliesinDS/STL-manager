"""
Compatibility shim: delegates to canonical implementation in scripts/40_kits/backfill_kits.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "40_kits" / "backfill_kits.py"
MODULE_NAME = "scripts.40_kits.backfill_kits"
