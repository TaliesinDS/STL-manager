"""Compatibility shim: delegates to canonical implementation in scripts/20_loaders/create_missing_franchises.py"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "20_loaders" / "create_missing_franchises.py"
MODULE_NAME = "scripts.20_loaders.create_missing_franchises"
