"""Compatibility shim for scripts.match_parts_to_variants.

Canonical module moved to scripts/30_normalize_match/match_parts_to_variants.py.
...
_IMPL_PATH = _ROOT / "scripts" / "30_normalize_match" / "match_parts_to_variants.py"
...
if not _IMPL_PATH.is_file():
    raise FileNotFoundError(f"Relocated match_parts_to_variants not found at {_IMPL_PATH}")

_SPEC = importlib.util.spec_from_file_location(
    "scripts.match_parts_to_variants_impl", str(_IMPL_PATH)
)
