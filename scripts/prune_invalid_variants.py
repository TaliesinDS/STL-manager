"""
Compatibility shim: delegates to canonical implementation in scripts/50_cleanup_repair/prune_invalid_variants.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "50_cleanup_repair" / "prune_invalid_variants.py"
MODULE_NAME = "scripts.50_cleanup_repair.prune_invalid_variants"
