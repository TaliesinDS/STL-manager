"""
Compatibility shim: delegates to canonical implementation in scripts/30_normalize_match/apply_sample_folder_tokens.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "30_normalize_match" / "apply_sample_folder_tokens.py"
MODULE_NAME = "scripts.30_normalize_match.apply_sample_folder_tokens"
