...
Usage:
    python scripts/50_cleanup_repair/clear_variant_franchise.py 66 330 331
    python scripts/50_cleanup_repair/clear_variant_franchise.py 66 330 331 --apply
    python scripts/50_cleanup_repair/clear_variant_franchise.py 309 --apply --also-character
"""
