"""Compatibility shim for scripts.apply_proposals_from_report.

Canonical module moved to scripts/30_normalize_match/apply_proposals_from_report.py.
...
_IMPL_PATH = _ROOT / "scripts" / "30_normalize_match" / "apply_proposals_from_report.py"
...
if not _IMPL_PATH.is_file():
    raise FileNotFoundError(f"Relocated apply_proposals_from_report not found at {_IMPL_PATH}")

_SPEC = importlib.util.spec_from_file_location(
    "scripts.apply_proposals_from_report_impl", str(_IMPL_PATH)
)
