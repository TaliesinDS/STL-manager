"""
Compatibility shim: delegates to canonical implementation in scripts/40_kits/fix_infernus_kit.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "40_kits" / "fix_infernus_kit.py"
MODULE_NAME = "scripts.40_kits.fix_infernus_kit"
