#!/usr/bin/env python3
"""
Compatibility shim: delegates to canonical implementation in scripts/50_cleanup_repair/delete_variant.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "50_cleanup_repair" / "delete_variant.py"
MODULE_NAME = "scripts.50_cleanup_repair.delete_variant"
