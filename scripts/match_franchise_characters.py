"""Compatibility shim for scripts.match_franchise_characters.

Canonical module moved to scripts/30_normalize_match/match_franchise_characters.py.
...
_IMPL_PATH = _ROOT / "scripts" / "30_normalize_match" / "match_franchise_characters.py"
...
if not _IMPL_PATH.is_file():
    raise FileNotFoundError(f"Relocated match_franchise_characters not found at {_IMPL_PATH}")

_SPEC = importlib.util.spec_from_file_location(
    "scripts.match_franchise_characters_impl", str(_IMPL_PATH)
)
