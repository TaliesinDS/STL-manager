"""
Compatibility shim: delegates to canonical implementation in scripts/50_cleanup_repair/remove_loose_files_from_variant.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "50_cleanup_repair" / "remove_loose_files_from_variant.py"
MODULE_NAME = "scripts.50_cleanup_repair.remove_loose_files_from_variant"
