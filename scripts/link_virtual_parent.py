"""
Compatibility shim: delegates to canonical implementation in scripts/40_kits/link_virtual_parent.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "40_kits" / "link_virtual_parent.py"
MODULE_NAME = "scripts.40_kits.link_virtual_parent"
