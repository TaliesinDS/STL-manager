"""
Compatibility shim: delegates to canonical implementation in scripts/10_inventory/create_sample_inventory.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "10_inventory" / "create_sample_inventory.py"
MODULE_NAME = "scripts.10_inventory.create_sample_inventory"
