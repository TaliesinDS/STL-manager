"""Compatibility shim for scripts.match_variants_to_units.

Canonical module moved to scripts/30_normalize_match/match_variants_to_units.py.
...
_IMPL_PATH = _ROOT / "scripts" / "30_normalize_match" / "match_variants_to_units.py"
...
if not _IMPL_PATH.is_file():
    raise FileNotFoundError(f"Relocated match_variants_to_units not found at {_IMPL_PATH}")

_SPEC = importlib.util.spec_from_file_location(
    "scripts.match_variants_to_units_impl", str(_IMPL_PATH)
)
