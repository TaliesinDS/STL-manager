"""Compatibility shim for scripts.filter_proposals.

Canonical module moved to scripts/60_reports_analysis/filter_proposals.py.
...
_IMPL_PATH = _ROOT / "scripts" / "60_reports_analysis" / "filter_proposals.py"
...
if not _IMPL_PATH.is_file():
    raise FileNotFoundError(f"Relocated filter_proposals not found at {_IMPL_PATH}")

_SPEC = importlib.util.spec_from_file_location(
    "scripts.filter_proposals_impl", str(_IMPL_PATH)
)
