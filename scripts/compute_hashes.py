"""
Compatibility shim: delegates to canonical implementation in scripts/10_inventory/compute_hashes.py
"""
...
PROJECT = ROOT.parent
CANON = PROJECT / "scripts" / "10_inventory" / "compute_hashes.py"
MODULE_NAME = "scripts.10_inventory.compute_hashes"
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Prefer calling main(argv) to support canonical signature main(argv: list[str])
    # Fall back to main() if the canonical script expects no arguments
    import sys as _sys
